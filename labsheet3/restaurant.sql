...
--Exercise 1
--1
--SELECT VENDORID FROM INGREDIENTS WHERE ingredientid='GRAPE'
--2
--SELECT ingredientid FROM INGREDIENTS WHERE INVENTORY>100 AND FOODGROUP='FRUIT'
--3
...
--5
--SELECT COUNT(VENDORID),referredby FROM VENDORS GROUP BY referredby HAVING COUNT(VENDORID)>1
